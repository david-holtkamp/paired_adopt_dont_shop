...
ActiveRecord::Schema.define(version: 20200213033519) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.integer "rating"
    t.string "content"
    t.string "image", default: "https://images-na.ssl-images-amazon.com/images/I/51-TrKw%2BYtL._AC_SX355_.jpg"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "shelter_id"
